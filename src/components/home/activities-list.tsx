  ...
  return (
    <ul className="flex w-full flex-col gap-2">
      {data.map((data, index) => (
        <li
          key={index}
          className="hover:border-primary/60 w-full rounded-lg border-2 border-white bg-white transition-all duration-300"
        >
          <Link
            href={`/activities/#${data.company_name}`}
            className="flex flex-col justify-between p-6 sm:flex-row"
          >
